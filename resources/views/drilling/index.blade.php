            ...
            <tr>
                ...
                <td class="td-c">
                    <div class="act-group">
                        ...
                        <form method="POST" action="{{ route('drilling.destroy', $rec) }}" style="display:contents" onsubmit="event.preventDefault();confirmDelete('Delete this drilling record? This cannot be undone.',this)">
                            @csrf @method('DELETE')
