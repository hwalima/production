...
<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .alert-box { background: #fff7ed; border: 1px solid #fed7aa; border-left: 4px solid #f97316; border-radius: 10px; padding: 14px 18px; margin-bottom: 24px; font-size: 14px; color: #9a3412; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <div class="alert-box">
            🔒 Hi <strong>{{ $userName }}</strong>, your password has been reset by <strong>{{ $resetBy }}</strong>. Use the temporary password below to sign in.
        </div>

        <div class="section-label">Your New Login Credentials</div>
        ...
        <div class="notice">
            🔒 <strong>Important:</strong> You will be prompted to set a new password immediately after signing in. Do not share this temporary password with anyone.
        </div>
        ...
        <p style="font-size:13px;color:#6b7280;line-height:1.6;">
            If you did not expect this reset or believe it was made in error, please contact your system administrator immediately.
        </p>
    ...
    {{-- Footer --}}
    <div class="footer">
        <p>{{ $companyName }} &nbsp;·&nbsp; This is an automated security notification.</p>
