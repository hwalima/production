@extends('layouts.app')
@section('title', 'Import Production')
@section('page-title', 'Bulk Import')
@section('content')

<div style="max-width:760px;">
    <div class="page-header">
        <h1 class="page-title">Import Production Records</h1>
    ...
    <div class="form-card" style="margin-bottom:20px;">
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;margin-bottom:20px;">
            ...
            <a href="{{ route('import.template', 'production') }}"
        ...
        <form action="{{ route('import.production.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <div class="form-card">
        ...
        <table class="data-table" style="font-size:.78rem;">
            ...
            <tbody>
                ...
                <tr><td><code>fidelity_price</code></td><td style="color:#22c55e;">Yes</td><td>Price per gram (local currency)</td></tr>
            </tbody>
        </table>
        </div>
    </div>
