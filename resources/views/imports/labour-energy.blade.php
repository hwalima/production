@extends('layouts.app')
@section('title', 'Import Labour & Energy')
@section('page-title', 'Bulk Import')
@section('content')

<div style="max-width:760px;">
    <div class="page-header">
        <h1 class="page-title">Import Labour &amp; Energy Costs</h1>
    ...
    <div class="form-card" style="margin-bottom:20px;">
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;margin-bottom:20px;">
            ...
            <a href="{{ route('import.template', 'labour-energy') }}"
        ...
        <form action="{{ route('import.labour-energy.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div style="display:flex;align-items:center;gap:8px;">
                ...
                <span style="font-size:.75rem;color:#9ca3af;">Existing records (same date) will be updated.</span>
            </div>
        </form>
    </div>
    ...
    <div class="form-card">
        ...
        <table class="data-table" style="font-size:.78rem;">
            ...
            <tbody>
                ...
                <tr><td><code>zesa_cost</code></td><td style="color:#22c55e;">Yes</td><td>ZESA electricity cost (decimal)</td></tr>
                <tr><td><code>diesel_cost</code></td><td style="color:#22c55e;">Yes</td><td>Diesel / generator cost (decimal)</td></tr>
                <tr><td><code>labour_cost</code></td><td style="color:#22c55e;">Yes</td><td>Total labour cost (decimal)</td></tr>
            </tbody>
        </table>
        </div>
        <div style="margin-top:12px;padding:12px 14px;background:var(--input-bg);border-radius:8px;font-size:.78rem;color:#9ca3af;">
            <strong style="color:var(--text);">Note:</strong> Department-level labour cost breakdowns are not currently supported via bulk import. After importing, open each record in the Labour &amp; Energy screen to add per-department splits.
        </div>
    </div>
</div>
