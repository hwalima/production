                    ...
                    <tr>
                        ...
                        <td class="td-c">
                            <div class="act-group">
                                ...
                                <form method="POST" action="{{ route('shifts.destroy', $s) }}" style="display:contents" onsubmit="event.preventDefault();confirmDelete('Delete shift: {{ $s->name }}? This cannot be undone.',this)">
                                    @csrf @method('DELETE')
